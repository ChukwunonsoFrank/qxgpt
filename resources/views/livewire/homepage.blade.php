                    ...
                    <div class="what-about__wrap col-12">
                        <div class="d-flex flex-row justify-content-start gap-2">
                            ...
                            <div class="d-flex flex-column">
                                <h5>Peace of Mind</h5>
                                <p class="text-white">
                                    At Qxgpt, we prioritize your peace of mind above all. Our commitment to providing a
                    ...
                    <div class="what-about__wrap col-12">
                        <div class="d-flex flex-row justify-content-start gap-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <p class="text-white">
                                    Qxgpt robot uses Artificial Intelligence to trade the market with the best algorithm
                                    ...
                                    trading skill to use the Qxgpt robot, it’s easy to use and it lets your money work
                                    for you.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="d-flex flex-row justify-content-start gap-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <p class="text-white">
                                    ...
                                    encrypted.The Qxgpt robot is profitable for everyone whereby your money works for
                                    you
                ...
                <div class="col-md-3">
                    <div class="text-center position-relative">
                        <div class="step-icon mx-auto border rounded-circle d-flex align-items-center justify-content-center"
                            style="width:70px;height:70px;background-color:#3b71ff;">
                            ...
                            <div class="accordion" id="Tech-accordion">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="Tech-headingOne"><button
                                            ...
                                            How does Qxgpt works?</button></h2>
                                    <div aria-labelledby="Tech-headingOne" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body" style="font-size: 14px;">
                                            Qxgpt is an automated Ai trading bot that helps you trade the forex and
                                            crypto
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div aria-labelledby="Tech-headingThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body" style="font-size: 14px;">
                                            ...
                                            Qxgpt with zero knowledge in trading. The Ai bot handles all the trades for
                                            you
