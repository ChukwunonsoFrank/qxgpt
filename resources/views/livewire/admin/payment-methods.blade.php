        ...
        <div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
            ...
            <div class="rounded-2xl mb-4 border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div class="p-5 space-y-6 border-t border-gray-100 dark:border-gray-800 sm:p-6">
                    <form wire:submit="createNewPaymentMethod()">
                        <div class="-mx-2.5 flex flex-wrap gap-y-5">
                            ...
                            <div class="w-full px-2.5 xl:w-1/2">
                                <input wire:model="address" type="text" placeholder="Wallet Address"
                                    class="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                            </div>
                            ...
                            <table class="min-w-full">
                                <thead class="border-y border-gray-100 py-3 dark:border-gray-800">
                                    ...
                                    <th class="px-5 py-3 font-normal whitespace-nowrap sm:px-6">
                                        <div class="flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">Slug
                                            </p>
                                        </div>
                                    </th>
                                    <th class="px-5 py-3 font-normal whitespace-nowrap sm:px-6">
                                        <div class="flex items-center">
                                            <p class="text-theme-sm text-gray-500 dark:text-gray-400">Wallet Address
                                            </p>
                                        </div>
                                    </th>
                                </thead>
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                    @forelse ($paymentMethods as $method)
                                        <tr wire:key="method-{{ $method['id'] }}" x-data="{ isActionDropdownOpen: false }">
                                                ...
                                                <div class="flex items-center justify-center">
                                                    <div class="relative">
                                                        ...
                                                        <div x-show="isActionDropdownOpen"
                                                            ...
                                                            <a
                                                                href="{{ route('admin.dashboard.paymentmethods.details', ['id' => $method['id']]) }}">
                                                            ...
                                                            <form wire:submit.prevent="destroyStrategy({{ $method['id'] }})">
                                                                <button type="submit"
