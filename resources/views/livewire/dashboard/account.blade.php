                ...
                <div class="mb-3 grid grid-cols-1 gap-1 lg:grid-cols-2 lg:gap-2 lg:mb-2">
                    ...
                    <a href="{{ route('dashboard.accountmanager') }}">
                        <div
                            ...
                            <div class="flex-1">
                                <p class="font-medium text-sm text-white">Account Manager</p>
                            </div>
                            <div class="flex-none text-end">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_account_manager_telegram)">
                                        <path
                                            d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24Z"
                                            fill="url(#paint0_account_manager_telegram)" />
                                        <path
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_account_manager_telegram" x1="12" y1="24"
                                            x2="12" y2="0" gradientUnits="userSpaceOnUse">
                                            <stop stop-color="#1D93D2" />
                                            <stop offset="1" stop-color="#38B0E3" />
                                        </linearGradient>
                                        <clipPath id="clip0_account_manager_telegram">
